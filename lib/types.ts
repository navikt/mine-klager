...
export enum EventType {
  ...
  GJENOPPTAKSBEGJAERING_MOTTATT_KLAGEINSTANS = 'GJENOPPTAKSBEGJAERING_MOTTATT_KLAGEINSTANS',
  GJENOPPTAKSBEGJAERING_SENDT_TRYGDERETTEN = 'GJENOPPTAKSBEGJAERING_SENDT_TRYGDERETTEN',
  GJENOPPTAKSBEGJAERING_KJENNELSE_MOTTATT_FRA_TRYGDERETTEN = 'GJENOPPTAKSBEGJAERING_KJENNELSE_MOTTATT_FRA_TRYGDERETTEN',
  GJENOPPTAKSBEGJAERING_AVSLUTTET_I_TRYGDERETTEN = 'GJENOPPTAKSBEGJAERING_AVSLUTTET_I_TRYGDERETTEN',
  GJENOPPTAKSBEGJAERING_AVSLUTTET_I_KLAGEINSTANS = 'GJENOPPTAKSBEGJAERING_AVSLUTTET_I_KLAGEINSTANS',
}

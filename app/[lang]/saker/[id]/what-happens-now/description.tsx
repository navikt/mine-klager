...
const PARAGRAPHS: Record<EventType, Translation<React.ReactNode[]>> = {
  [EventType.KLAGE_MOTTATT_VEDTAKSINSTANS]: {
    [Language.NB]: [
      ...
      `Dersom ${UNIT.vedtaksinstans.nb} gir deg medhold, vil du motta et nytt vedtak.`,
      `Dersom ${UNIT.vedtaksinstans.nb} ikke gir deg medhold, vil klagen bli sendt videre til ${UNIT.klageinstans.nb}.`,
    ],
    [Language.NN]: [
      `${UNIT.vedtaksinstans.nn} har mottatt klagen din og vurderer den på nytt.`,
      `Dersom ${UNIT.vedtaksinstans.nn} gir deg medhald, vil du motta eit nytt vedtak.`,
      `Dersom ${UNIT.vedtaksinstans.nn} ikkje gir deg medhald, vil klagen bli send vidare til ${UNIT.klageinstans.nn}.`,
    ],
    [Language.EN]: [
      `${UNIT.vedtaksinstans.en} has received your complaint and is reviewing it.`,
      `If ${UNIT.vedtaksinstans.en} rules in your favor, you will receive a new decision.`,
      `If ${UNIT.vedtaksinstans.en} does not rule in your favor, the complaint will be sent to ${UNIT.klageinstans.en}.`,
    ],
  },
  [EventType.KLAGE_MOTTATT_KLAGEINSTANS]: {
    [Language.NB]: [
      `${UNIT.klageinstans.nb} skal behandle klagen din, og vil da vurdere saken din på nytt.`,
      `${UNIT.klageinstans.nb} har tilgang til alle dokumentene i saken din. Dersom vi mangler opplysninger, vil vi innhente disse.`,
    ...
    [Language.NN]: [
      ...
      `${UNIT.klageinstans.nn} har tilgang til alle dokumenta i saka di. Dersom vi manglar opplysningar, vil vi hente inn desse.`,
    ...
    [Language.EN]: [
      ...
      `${UNIT.klageinstans.en} has access to all the documents in your case. If we lack information, we will obtain it.`,
  ...
  [EventType.KLAGE_AVSLUTTET_I_KLAGEINSTANS]: {
    [Language.NB]: [
      `${UNIT.klageinstans.nb} har behandlet klagen din. Du kan lese avgjørelsen i brevet du har fått fra ${UNIT.klageinstans.nb}.`,
    ...
    [Language.NN]: [
      `${UNIT.klageinstans.nn} har behandla klagen din. Du kan lese avgjerda i brevet du har fått frå ${UNIT.klageinstans.nn}.`,
    ...
    [Language.EN]: [
      `${UNIT.klageinstans.en} has processed your complaint. You can read the decision in the letter you received from ${UNIT.klageinstans.en}.`,
  ...
  [EventType.ANKE_AVSLUTTET_I_KLAGEINSTANS]: {
    [Language.NB]: [
      `${UNIT.klageinstans.nb} har behandlet anken din uten å sende saken videre til ${UNIT.trygderetten.nb}. Du kan lese avgjørelsen i brevet du har fått fra ${UNIT.klageinstans.nb} i dokumentarkivet.`,
    ],
    [Language.NN]: [
      `${UNIT.klageinstans.nn} har behandla anken din uten å sende saka vidare til ${UNIT.trygderetten.nn}. Du kan lese avgjerda i brevet du har fått frå ${UNIT.klageinstans.nb} i dokumentarkivet.`,
    ],
    [Language.EN]: [
      `${UNIT.klageinstans.en} has processed your appeal without sending the case on to the ${UNIT.trygderetten.en}. You can read the decision in the letter you received from ${UNIT.klageinstans.en} in the document archive.`,
    ],
  },
  [EventType.ANKE_SENDT_TRYGDERETTEN]: {
    [Language.NB]: [
      `${UNIT.klageinstans.nb} har behandlet anken din, og anken din er sendt videre til ${UNIT.trygderetten.nb}.`,
      <>
        <span key="tr">
    ...
    [Language.NN]: [
      `${UNIT.klageinstans.nn} har behandla anken din, og anken din er sendt vidare til ${UNIT.trygderetten.nn}.`,
      <>
        <span key="tr">
    ...
    [Language.EN]: [
      `${UNIT.klageinstans.nn} has processed your appeal, and your appeal has been sent on to the ${UNIT.trygderetten.en}.`,
      <>
        <span key="tr">
  ...
  [EventType.ANKE_KJENNELSE_MOTTATT_FRA_TRYGDERETTEN]: {
    [Language.NB]: [
      `${UNIT.trygderetten.nb} har behandlet anken din. Du kan lese avgjørelsen i kjennelsen fra ${UNIT.trygderetten.nb}.`,
      <>
    ...
    [Language.NN]: [
      `${UNIT.trygderetten.nn} har behandla anken din. Du kan lese avgjerda i kjennelsen frå ${UNIT.trygderetten.nn}.`,
      <>
    ...
    [Language.EN]: [
      `The ${UNIT.trygderetten.en} has processed your appeal. You can read the decision in the judgment from the ${UNIT.trygderetten.en}.`,
      <>
  ...
  [EventType.OMGJOERINGSKRAV_AVSLUTTET_I_KLAGEINSTANS]: {
    [Language.NB]: [
      `${UNIT.klageinstans.nb} har behandlet omgjøringskravet ditt. Du kan lese avgjørelsen i brevet du har fått fra ${UNIT.klageinstans.nb} i dokumentarkivet.`,
    ],
    [Language.NN]: [
      `${UNIT.klageinstans.nn} har behandla omgjeringskravet ditt. Du kan lese avgjerda i brevet du har fått frå ${UNIT.klageinstans.nn} i dokumentarkivet.`,
    ],
    [Language.EN]: [
      `${UNIT.klageinstans.en} has processed your request for reconsideration. You can read the decision in the letter you received from ${UNIT.klageinstans.en} in the document archive.`,
    ],
  },
  ...
  [EventType.GJENOPPTAKSBEGJAERING_SENDT_TRYGDERETTEN]: {
    [Language.NB]: [
      `${UNIT.klageinstans.nb} har behandlet begjæringen din om gjenopptak, og begjæringen din er sendt videre til ${UNIT.trygderetten.nb}.`,
      <>
        <span key="tr">
          Du kan sende brev eller dokumenter til {UNIT.trygderetten.nb} via eDialog, som du finner på{' '}
          <TrygderettenLink lang={Language.NB} />, eller i posten til adressen:
    ...
    [Language.NN]: [
      `${UNIT.klageinstans.nn} har behandla kravet ditt om gjenopning, og kravet ditt er sendt vidare til ${UNIT.trygderetten.nn}.`,
      <>
        <span key="tr">
          Du kan sende brev eller dokument til {UNIT.trygderetten.nn} via eDialog, som du finn på{' '}
          <TrygderettenLink lang={Language.NN} />, eller i posten til adressa:
    ...
    [Language.EN]: [
      `${UNIT.klageinstans.en} has processed your request for reopening, and your request has been sent on to the ${UNIT.trygderetten.en}.`,
      <>
        <span key="tr">
          You can send letters or documents to the {UNIT.trygderetten.en} via eDialog, which you can find at{' '}
          <TrygderettenLink lang={Language.EN} />, or by mail to the address:
  ...
  [EventType.GJENOPPTAKSBEGJAERING_KJENNELSE_MOTTATT_FRA_TRYGDERETTEN]: {
    [Language.NB]: [
      `${UNIT.trygderetten.nb} har behandlet begjæringen din om gjenopptak. Du kan lese avgjørelsen i kjennelsen fra ${UNIT.trygderetten.nb}.`,
    ],
    [Language.NN]: [
      `${UNIT.trygderetten.nn} har behandla kravet ditt om gjenopning. Du kan lese avgjerda i kjennelsen frå ${UNIT.trygderetten.nn}.`,
    ],
    [Language.EN]: [
      `The ${UNIT.trygderetten.en} has processed your request for reopening. You can read the decision in the judgment from the ${UNIT.trygderetten.en}.`,
    ],
  },
  ...
  [EventType.GJENOPPTAKSBEGJAERING_AVSLUTTET_I_KLAGEINSTANS]: {
    [Language.NB]: [
      `${UNIT.klageinstans.nb} har behandlet begjæringen din om gjenopptak. Du kan lese avgjørelsen i brevet du har fått fra ${UNIT.klageinstans.nb} i dokumentarkivet.`,
    ],
    [Language.NN]: [
      `${UNIT.klageinstans.nn} har behandla kravet ditt om gjenopning. Du kan lese avgjerda i brevet du har fått frå ${UNIT.klageinstans.nn} i dokumentarkivet.`,
    ],
    [Language.EN]: [
      `${UNIT.klageinstans.en} has processed your request for reopening. You can read the decision in the letter you received from ${UNIT.klageinstans.en} in the document archive.`,
    ],
  },
};

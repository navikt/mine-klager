...
import { BodyShort, Box, Heading, Link, type LinkProps, VStack } from '@navikt/ds-react';
...
const TrygderettenLink = ({ lang }: ResourceLinkProps) => (
  <ExternalLink href={lang === Language.EN ? 'https://trygderetten.no/en' : 'https://trygderetten.no'}>
    trygderetten.no
  </ExternalLink>
);

const DomstolLink = ({ lang }: ResourceLinkProps) => (
  ...
  [EventType.ANKE_KJENNELSE_MOTTATT_FRA_TRYGDERETTEN]: {
    ...
    [Language.EN]: [
      ...
      <>
        ...
        You can read more about this at <DomstolLink key="domstol" lang={Language.EN} />.
      </>,
    ],
  },
  // TODO: Verify that the user has access to the decision from Trygderetten before referencing the document archive.

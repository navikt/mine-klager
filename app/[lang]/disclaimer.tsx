...
const FIRST_LINE: Translation = {
  ...
  [Language.NN]: `Alle klager blir behandla av ${UNIT.vedtaksinstans.nn} før dei blir vist her.`,
...
const SECOND_LINE: Translation = {
  ...
  [Language.NN]: `Her ser du klager og ankar som er hos ${UNIT.klageinstans.nn}. Du ser berre klager og ankar for nokre ytingar.`,
